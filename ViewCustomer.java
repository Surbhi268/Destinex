...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username){
       ...
       JLabel image2= new JLabel(i6);//JLabel can't be used directly with Image i2 or i1
       ...
       try{
           ...
           while(rs.next()){
               ...
               labelid.setText(rs.getString("id")); labelname.setText(rs.getString("name"));
